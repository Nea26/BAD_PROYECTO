...
@section('content')
    ...
    <div class="container-fluid" style="margin: 50px 0;">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                Bienvenido a esta sección, aquí se muestran todos libros que se encuentran registrados en el sistema hasta
                la fecha.
            </div>
        </div>
    </div>
                    ...
                    <div class="div-table" style="margin:0 !important;">
                        ...
                        @if(auth()->user()->hasRole('profesor')||auth()->user()->hasRole('miembro'))
                            <div class="div-table-cell" style="width: 8%;">
                                <a href="CrearPrestamo.html" class="btn btn-info"><i
                                        class="zmdi zmdi-book"></i></a>
                            </div>
                        @endif
                            @if (auth()->user()->hasRole('bibliotecario'))
                                <div class="div-table-cell" style="width: 8%;">
                                    <a href="{{ route('catalogo.edit', $libro->id) }}" class="btn btn-info"><i
                                            class="zmdi zmdi-file-text"></i></a>
                                </div>
                                <div class="div-table-cell" style="width: 8%;">
                                    <form action="{{ route('book.destroy', $libro->id) }}" method="POST"
                                        class="delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <style>
        ...
        .modal-body ul {
            padding-left: 20px;
            /* Ajusta el padding para la lista */
        }
